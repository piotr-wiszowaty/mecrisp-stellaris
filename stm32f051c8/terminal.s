...
uart_init:
	...
	.ifdef pll
	@ Flash access time = 1 wait state
	ldr r1, =FLASH_ACR
	ldr r0, [r1]
	ldr r2, =~0x07
	ands r0, r2
...
1:	ldr r0, [r1]
	...
	@ configure PLL
	ldr r1, =RCC_CFGR
	ldr r0, =0x00050000		@ PLLMUL=x3, PLLSRC=HSE
	str r0, [r1]
	@ PLL on
	ldr r1, =RCC_CR
	ldr r0, [r1]
...
1:	ldr r0, [r1]
	...
	ldr r1, =RCC_CFGR
	ldr r0, [r1]
	ldr r2, =0x00000002		@ SYSCLK = PLL
	orrs r0, r2
	str r0, [r1]
	ldr r2, =0x0000000C		@ SWS
	ldr r3, =0x00000008		@ SYSCLK = PLL
1:	ldr r0, [r1]
	ands r0, r2
	cmp r0, r3
	bne 1b
