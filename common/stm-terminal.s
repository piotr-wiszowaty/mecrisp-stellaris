...
@ Divider 4, Fractional term 5 or 6 --> $45 or $46.
	...
	@ mov r0, #0x45		@ 115200 bps, 8 MHz
	@ mov r0, #312		@ 115200 bps, 36 MHz
	mov r0, #78		@ 460800 bps, 36 MHz
	@ mov r0, #36		@ 1 Mbps, 36 MHz
	str r0, [r1]
	...
	@ Enable RTS, CTS
	ldr r1, =Terminal_USART_CR3
	ldr r0, =BIT9+BIT8 @ USART_CR3_CTSE | USART_CR3_RTSE
	str r0, [r1]
