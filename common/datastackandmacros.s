...
.macro defword_Kernende Flags, Name
...
9:      .word FLASH_DICTIONARY_START + 0x0C @ Insert Link with offset because of alignment issues.
   .else
     .ifdef flash8bytesblockwrite
9:      .word FLASH_DICTIONARY_START + 0x04 @ Insert Link with offset because of alignment issues.
     .else
9:      .word FLASH_DICTIONARY_START  @ Link einfügen  Insert Link
     .endif
   .endif
        .hword \Flags     @ Flags setzen, diesmal 2 Bytes ! Wir haben Platz und Ideen :-)  Flag field, 2 bytes, space for ideas left !
...
@ Automatic erase of flash dictionary after initial boot
	...
	.org FLASH_DICTIONARY_START, erasedword	@ Synthesise a definition at the beginning of the user flash dictionary
...
.macro Dictionary_Welcome
  defword Flag_invisible, "--- Mecrisp-Stellaris RA 2.5.3 ---"
.endm
...
.macro Dictionary_Welcome
  defword Flag_invisible, "--- Mecrisp-Stellaris 2.5.3 ---"
.endm
