...
@ Hardwired core variables, buffers and stacks at the begin of RAM
	...
	.set rampointer, RAM_START  @ Ram-Anfang setzen  Set location for core variables.
	...
	.equ RAM_DICTIONARY_START, rampointer	@ Start of RAM dictionary
	.equ RAM_DICTIONARY_END,   RAM_END	@ End of RAM dictionary = End of RAM

@ -----------------------------------------------------------------------------
@ Preparations for dictionary structure

core_dictionary_start:				@ Set entry point for Dictionary

	.set CoreVariablenPointer, RAM_DICTIONARY_END	@ Variables defined in Flash are placed at the end of RAM
...
@ Finalize the dictionary structure and put a pointer into changeable Flash-Dictionary
	...
	defword_Kernende Flag_invisible, "--- Flash Dictionary ---"
