...
@------------------------------------------------------------------------------
  defword Flag_visible, "cjump," @ Fügt einen bedingten Sprung ein. Write a conditional jump into dictionary
...
@------------------------------------------------------------------------------
  defword Flag_visible, "jump," @ Fügt einen unbedingten Sprung ein.  Write an unconditional jump into dictionary
...
@ -----------------------------------------------------------------------------
  defword Flag_visible, "here" @ ( -- addr ) Gives Dictionarypointer
...
@ -----------------------------------------------------------------------------
  defword Flag_visible, "flashvar-here" @ ( -- a-addr ) Gives RAM management pointer
flashvarhere:
@ -----------------------------------------------------------------------------
  pushdatos
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "then"
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "else"
@------------------------------------------------------------------------------
  push {lr}
  bl struktur_ahead
  bl dswap
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly|Flag_allocator|Flag_Sprungschlucker, "if"
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "ahead"
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "repeat"
@------------------------------------------------------------------------------
  push {lr}
  bl struktur_again
  bl struktur_then
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly|Flag_allocator|Flag_Sprungschlucker, "while"
@------------------------------------------------------------------------------
  push {lr}
  bl struktur_if
  bl dswap
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly|Flag_allocator|Flag_Sprungschlucker, "until"  @ Bedingte Schleife
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "again"  @ Endlosschleife
...
@------------------------------------------------------------------------------
  defword Flag_immediate_compileonly, "begin"
