...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_1|Flag_inline|Flag_allocator, "0=" @ ( x -- ? )
@ -----------------------------------------------------------------------------
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_1|Flag_inline|Flag_allocator, "0<" @ ( n -- ? )
@ -----------------------------------------------------------------------------
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_0|Flag_inline, "true" @ ( -- -1 )
@ -----------------------------------------------------------------------------
  pushdatos
generate_true:
  movs tos, #0
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_0|Flag_inline, "false" @ ( x -- 0 )
@ -----------------------------------------------------------------------------
  pushdatos
  movs tos, #0
  bx lr
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_2|Flag_allocator, ">=" @ ( x1 x2 -- ? )
@ -----------------------------------------------------------------------------
...
@ -----------------------------------------------------------------------------
  defword Flag_inline|Flag_foldable_2|Flag_allocator, "u>=" @ ( u1 u2 -- ? )
@ -----------------------------------------------------------------------------
...
@ -----------------------------------------------------------------------------
  defword Flag_inline|Flag_foldable_2|Flag_allocator, "<>" @ ( x1 x2 -- ? )
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_2|Flag_inline|Flag_allocator, "min" @ ( x1 x2 -- x3 )
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_2|Flag_inline|Flag_allocator, "max" @ ( x1 x2 -- x3 )
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_2|Flag_inline|Flag_allocator, "umax" @ ( u1 u2 -- u1|u2 )
@ -----------------------------------------------------------------------------
  ldm psp!, {r0}
  cmp r0, tos
  blo 1f
...
@ -----------------------------------------------------------------------------
  defword Flag_foldable_2|Flag_inline|Flag_allocator, "umin" @ ( u1 u2 -- u1|u2 )
@ -----------------------------------------------------------------------------
  ldm psp!, {r0}
  cmp r0, tos
  bhi 1f
